...
export const List: FunctionComponent<Props> = ({ moviess }) => (
  <div className="p-4">
    <div className="flex justify-between items-center">
      <h1 className="text-3xl mb-2">Movies List</h1>
      <Link
        href="/moviess/create"
      ...
      <tbody className="text-sm divide-y divide-gray-200">
        {moviess &&
          ...
          moviess.map(
            (movies) =>
              movies["@id"] && (
                <tr className="py-2" key={movies["@id"]}>
                  <th scope="row">
                    <ReferenceLinks
                      items={{
                        href: getItemPath(movies["@id"], "/moviess/[id]"),
                        name: movies["@id"],
                      }}
                    />
                  </th>
